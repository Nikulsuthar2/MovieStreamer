    ...
    <div class="mainbody">
        ...
        <div class="mainview">
            ...
            <div class="mainform">
                ...
                <form class="actordtl" action="updateMovie.php" method="POST" enctype="multipart/form-data">
                            ...
                            if($res)
                            {
                                ...
                                if(isset($_POST['Mcast'])){
                                    ...
                                    foreach($_POST['Mcast'] as $mcast){
                                        $sql1 = "insert into cast_dtl values($mov_id,$mcast)";
                                ...
                                if(isset($_POST['Mcategory'])){
                                    ...
                                    foreach($_POST['Mcategory'] as $mcat){
                                        $sql2 = "insert into genre_dtl values($mov_id,$mcat)";
