                ...
                <div class="litable">
                    <table>
                        ...
                        if(isset($_POST['search']))
                        {
                            ...
                            $search = $_POST['search'];
                            $sql = "select * from actor_dtl where name like '%".$search."%' limit 10";
                            unset($_POST['search']);
                        }
                        else
                        {
                            // get all actor list
                            $sql = "select * from actor_dtl order by name limit 10";
                        }
                        ...
                        if($res){
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                ...
                                <td><a href='$row[imagepath]'>
                                    <img src='".$row['imagepath']."' width='50px' style='border-radius: 20%'>
                                </a></td>
                                <td>".$row['name']."</td>
                                <td>
