                ...
                <div class="litable">
                    <table>
                        ...
                        <?php
                         ...
                         {
                             $search = $_POST['search'];
                             $sql = "select * from movie_dtl where name like '%".$search."%'";
                             unset($_POST['search']);
                         }
                         else
                         {
                             $sql = "select * from movie_dtl order by name";
                         }
                        ...
                        if($res){
                            ...
                            while($row = mysqli_fetch_assoc($res)){
                                echo "<tr>
                                <td>".$count."</td>
                                <td><a href='$row[moviepath]'><img src='".$row['posterpath']."' width='50px' height='70px' style='object-fit:cover;border-radius:10px'></a></td>
                                <td>".$row['Name']."</td>
                                <td>".$row['Provider']."</td>
                                <td>".$row['releasedt']."</td>
                                <td>
