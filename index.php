...
<body>
    <nav>
        ...
        <ul class="drawer">
            ...
            <li><a class="loginbtn" href="User/UserLogin.php">LOG IN</a></li>
        </ul>
    </nav>
    <!--Main Body -->
    <div class="mainbody">
        <h1 class="heading1">Watch Unlimited Movies <br>and more.</h1>
        <!--User signin form button  -->
        <a class="signinbtn" href="User/UserSignin.php">GET STARTED</a>
    </div>
</body>
</html>
